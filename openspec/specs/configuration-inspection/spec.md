# Configuration Inspection Specification

## Purpose

Expose effective storage and session hook settings and the configuration file
location without executing hooks or modifying configuration and lifecycle storage.
