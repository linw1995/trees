...
- [x] 5.2 Wire Clap parsing and `main` dispatch for automatic create, claim
  release, and checkin; print stable shell variables for workspace, pool key,
  and claim ID while keeping human-readable errors
...
- [x] 6.2 Add integration tests for pool allocation, root resolution, generated
  paths, concurrency, operation recovery, rejected dirty checkin, and mode
