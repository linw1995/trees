...
- [ ] 3.3 Wire `trees codex` dispatch to project synchronization and thread startup without changing Git or lifecycle snapshot state; add CLI-level integration coverage for direct native arguments, fake app-server handoff, and no Git mutations
