...
- [ ] 2.1 Add typed session identity, initial outcome, and Snafu launch/wait errors in a focused module; verify unit tests preserve source chains and outcome precedence.
