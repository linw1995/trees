...
- [x] 3.1 Implement direct executable invocation without additional command-line arguments with inherited environment, inherited working directory, concurrent pipe servicing, and typed Snafu errors. Verify executable paths containing spaces, no extra arguments, executable shebang scripts, one batch request, standard input EOF, and missing or non-executable files using fake providers.
