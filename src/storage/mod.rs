...
pub use repository::{
    ...
    operation_lease_for_mutation, operation_state, persist_operation_intent,
    ...
    record_workspace_explicitly_removed, record_workspace_gc_failure, record_workspace_gc_skipped,
    record_workspace_release, record_workspace_release_rejection, record_workspace_remove_failure,
