...
pub use repository::{
    ...
    record_workspace_acquire_failure, record_workspace_explicitly_reclaimed,
    record_workspace_gc_failure, record_workspace_gc_skipped, record_workspace_reclaim_failure,
    record_workspace_reclaim_skipped, record_workspace_reclaimed, record_workspace_release,
