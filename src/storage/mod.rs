...
pub use repository::{
    ...
    find_running_operation, find_workspace, find_workspace_by_path, find_workspace_lease,
    find_workspace_lease_by_id, insert_event, insert_operation, insert_repo_worktree,
    insert_workspace, insert_workspace_lease, list_automatic_workspace_candidates,
    ...
    record_workspace_checkin, record_workspace_checkout, record_workspace_lease_reclaim,
