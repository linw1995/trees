...
pub use repository::{
    ...
    find_workspace_by_path, find_workspace_lease, find_workspace_lease_by_id, find_workspace_pool,
    find_workspace_pool_by_id, insert_event, insert_managed_workspace, insert_operation,
    insert_origin_repository, insert_repo_worktree, insert_workspace, insert_workspace_lease,
    ...
    record_workspace_checkout_failure, record_workspace_gc_failure, record_workspace_gc_skipped,
    record_workspace_lease_expiration_failure, record_workspace_lease_reclaim,
    record_workspace_lease_renewal, record_workspace_reclaimed, record_workspace_transition,
    record_worktree_step_result, release_workspace_lease, renew_operation_lease,
    renew_workspace_lease, update_workspace_observation, EventDraft, OperationIntentError,
    TransitionMetadata,
};
