...
pub use repository::{
    ...
    insert_workspace_lease, list_automatic_workspace_candidates, list_automatic_workspaces,
    ...
    record_workspace_checkin, record_workspace_checkin_rejection, record_workspace_checkout,
